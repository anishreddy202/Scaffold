			...
			function parseV2() {
				...
				for (var path in swagger.paths) {
					for (var httpMethod in swagger.paths[path]) {
						...
						operation.realURL = $scope.infos.scheme +"://"+ $scope.infos.host + $scope.infos.basePath + path;
						form[operationId] = {
			...
			$scope.submitExplorer = function(operation) {
				...
				swaggerClient
					...
					.then(function(result) {
						...
						operation.explorerResult.realURL = operation.realURL
					});
			};
